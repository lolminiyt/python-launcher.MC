...
MC_DIR = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', '.minecraft'))
minecraft_dir = os.path.join(os.getcwd())
temp_dir = os.path.join(minecraft_dir, "temp")
...
def install_forge_version(versionid: str, path: Union[str, os.PathLike], callback: Optional[CallbackDict] = None, java: Optional[Union[str, os.PathLike]] = None) -> None:
    ...
    temp_file_path = os.path.join(temp_dir, "forge-installer-" + str(random.randrange(1, 100000)) + ".tmp")
